...
namespace hazedumper {
	inline std::int64_t timestamp = 1592954588;
	namespace netvars {
	...
	namespace signatures {
		...
		inline std::ptrdiff_t dwEntityList = 0x4D4F25C;
		inline std::ptrdiff_t dwForceAttack = 0x31807A8;
		inline std::ptrdiff_t dwForceAttack2 = 0x31807B4;
		inline std::ptrdiff_t dwForceBackward = 0x31807FC;
		inline std::ptrdiff_t dwForceForward = 0x3180808;
		inline std::ptrdiff_t dwForceJump = 0x51F8EF4;
		inline std::ptrdiff_t dwForceLeft = 0x3180820;
		inline std::ptrdiff_t dwForceRight = 0x3180814;
		inline std::ptrdiff_t dwGameDir = 0x629678;
		inline std::ptrdiff_t dwGameRulesProxy = 0x526C1EC;
		inline std::ptrdiff_t dwGetAllClasses = 0xD6103C;
		inline std::ptrdiff_t dwGlobalVars = 0x58AAD8;
		inline std::ptrdiff_t dwGlowObjectManager = 0x5297080;
		inline std::ptrdiff_t dwInput = 0x51A0808;
		inline std::ptrdiff_t dwInterfaceLinkList = 0x904AF4;
		inline std::ptrdiff_t dwLocalPlayer = 0xD3ABEC;
		inline std::ptrdiff_t dwMouseEnable = 0xD40790;
		inline std::ptrdiff_t dwMouseEnablePtr = 0xD40760;
		inline std::ptrdiff_t dwPlayerResource = 0x317EB40;
		inline std::ptrdiff_t dwRadarBase = 0x5183FCC;
		inline std::ptrdiff_t dwSensitivity = 0xD4062C;
		inline std::ptrdiff_t dwSensitivityPtr = 0xD40600;
		inline std::ptrdiff_t dwSetClanTag = 0x89FB0;
		inline std::ptrdiff_t dwViewMatrix = 0x4D40BA4;
		inline std::ptrdiff_t dwWeaponTable = 0x51A12C8;
		inline std::ptrdiff_t dwWeaponTableIndex = 0x325C;
		inline std::ptrdiff_t dwYawPtr = 0xD403F0;
		inline std::ptrdiff_t dwZoomSensitivityRatioPtr = 0xD45638;
		inline std::ptrdiff_t dwbSendPackets = 0xD415A;
		inline std::ptrdiff_t dwppDirect3DDevice9 = 0xA7030;
		inline std::ptrdiff_t find_hud_element = 0x302F2460;
		...
		inline std::ptrdiff_t m_pitchClassPtr = 0x5184268;
		inline std::ptrdiff_t m_yawClassPtr = 0xD403F0;

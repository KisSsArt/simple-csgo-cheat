...
unsigned long render::fonts::group_label_font;
unsigned long render::fonts::test_font;
...
void render::initialize() {
	...
	interfaces::surface->set_font_glyph(render::fonts::watermark_font, "Tahoma", 15, 600, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::group_label_font, "Tahoma", 25, 800, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::test_font, "Tahoma", 25, 800, 0, 0, font_flags::fontflag_dropshadow);

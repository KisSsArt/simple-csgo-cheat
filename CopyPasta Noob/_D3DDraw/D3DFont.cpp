...
CD3DFont::CD3DFont(const wchar_t* strFontName, DWORD dwHeight, DWORD dwWeight, DWORD dwFlags)
{
    wcsncpy_s(this->strFontName, strFontName, sizeof(this->strFontName) / sizeof(TCHAR));
    /*char lol1[80] = "gfh";
    const wchar_t *lol2 = L"2";
    size_t lol3 = 1;
    wcsncpy_s(lol1, lol2, lol3);*/
...
HRESULT CD3DFont::InitDeviceObjects(LPDIRECT3DDEVICE9 pd3dDevice)
{
    ...
    HFONT hFont    = CreateFont(nHeight, 0, 0, 0, this->dwFontWeight, dwItalic,
                                ...
                                VARIABLE_PITCH, (LPCSTR)this->strFontName);

...
void DrawManager::Line(Vec2 vecPos1, Vec2 vecPos2, color color) const
{
...
{
    D3DCOLOR dwColor = D3DCOLOR_ARGB(color.a, color.r, color.g, color.b);
    Vertex vert[2] = 
    {  
...
void DrawManager::Rect(Vec2 vecPos1, Vec2 vecPos2, color color) const
{
...
void DrawManager::RectFilled(Vec2 vecPos1, Vec2 vecPos2, color color) const
{
...
void DrawManager::Triangle(Vec2 pos1, Vec2 pos2, Vec2 pos3, color color) const
{
    D3DCOLOR dwColor = D3DCOLOR_ARGB(color.a, color.r, color.g, color.b);
    Vertex vert[4] =
    {
...
void DrawManager::TriangleFilled(Vec2 pos1, Vec2 pos2, Vec2 pos3, color color) const
{
    D3DCOLOR dwColor = D3DCOLOR_ARGB(color.a, color.r, color.g, color.b);
    Vertex vert[3] = 
    {  
...
void DrawManager::RectFilledGradient(Vec2 vecPos1, Vec2 vecPos2, color col1, color col2, GradientType vertical) const
{
    D3DCOLOR dwColor  = D3DCOLOR_ARGB(col1.a, col1.r, col1.g, col1.b);
    D3DCOLOR dwColor2 = D3DCOLOR_ARGB(col2.a, col2.r, col2.g, col2.b);
...
void DrawManager::RectFilledMultiColor(const Vec2& vecPos1, const Vec2& vecPos2, color colUprLeft, color colUprRight, color colBotLeft, color colBotRight) const
{
    Vertex vert[4] =
    {
        { vecPos1.x, vecPos1.y, 0.0f, 1.0f, D3DCOLOR_ARGB(colUprLeft.a, colUprLeft.r, colUprLeft.g, colUprLeft.b)},
        { vecPos2.x, vecPos1.y, 0.0f, 1.0f, D3DCOLOR_ARGB(colUprRight.a, colUprRight.r, colUprRight.g, colUprRight.b)},
        { vecPos1.x, vecPos2.y, 0.0f, 1.0f, D3DCOLOR_ARGB(colBotLeft.a, colBotLeft.r, colBotLeft.g, colBotLeft.b)},
        { vecPos2.x, vecPos2.y, 0.0f, 1.0f, D3DCOLOR_ARGB(colBotRight.a, colBotRight.r, colBotRight.g, colBotRight.b)},
    };
...
void DrawManager::String(Vec2 vecPos, DWORD dwFlags, color color, CD3DFont* pFont, const char* szText, ...) const
{
...
Vec2 DrawManager::GetScreenCenter()
{
    return { (static_cast<float>(this->pViewPort.Width) * 0.5f), (static_cast<float>(this->pViewPort.Height) * 0.5f) };
}
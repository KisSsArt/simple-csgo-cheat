...
auto do_frame = [&](std::int32_t x, std::int32_t y, std::int32_t width, std::int32_t height, color background, color header_text, color header_line, const std::string& name) {
		...
		render::draw_text_string(x + 10, y + 8, group_label_font, name, false, color::white());			//Header Name
};
...
void menu::render() {
	...
	group_box(-150, 115, 100, menu_params::height, watermark_font, "tabs", false); {
/*5*/	tab(-150, (260 / 2), 100, 30, group_label_font, "Aimbot", menu::current_tab, 0, false);
		tab(-150, (260 / 2) + 35, 100, 30, group_label_font, "Glow", menu::current_tab, 1, false);
		tab(-150, (260 / 2) + 70, 100, 30, group_label_font, "ESP", menu::current_tab, 2, false);
		tab(-150, (260 / 2) + 105, 100, 30, group_label_font, "Misc", menu::current_tab, 3, false);
	}
	...
	case 0: // Aimbot
		group_box(menu_params::MenuMargin, 85, menu_params::width - menu_params::MenuMargin * 2, menu_params::height - menu_params::MenuMargin * 2, watermark_font, "Aimbot", false); {
			...
			check_box(menu_params::MenuMargin + 10, 110, 310, watermark_font, "RageAim", rageaim_bool);
		}
		break;
	case 1: // Visuals
		group_box(menu_params::MenuMargin, 85, menu_params::width - menu_params::MenuMargin * 2, menu_params::height - menu_params::MenuMargin * 2, watermark_font, "Glow", false); {
			...
			check_box(menu_params::MenuMargin + 25, 110, 310, watermark_font, "Team", TeamGlow_bool);
			{
				...
				slider(menu_params::MenuMargin + 40, 140, 310, 125, watermark_font, "Team Color Red", TeamColorR, 0.f, 255.f);
				slider(menu_params::MenuMargin + 40, 155, 310, 125, watermark_font, "Team Color Green", TeamColorG, 0.f, 255.f);
				slider(menu_params::MenuMargin + 40, 170, 310, 125, watermark_font, "Team Color Blue", TeamColorB, 0.f, 255.f);
			...
			check_box(menu_params::MenuMargin + 25, 275, 310, watermark_font, "Enemy", EnemyGlow_bool);
			{
				...
				slider(menu_params::MenuMargin + 40, 305, 310, 125, watermark_font, "Enemy Color Red", EnemyColorR, 0.f, 255.f);
				slider(menu_params::MenuMargin + 40, 320, 310, 125, watermark_font, "Enemy Color Green", EnemyColorG, 0.f, 255.f);
				slider(menu_params::MenuMargin + 40, 335, 310, 125, watermark_font, "Enemy Color Blue", EnemyColorB, 0.f, 255.f);

...
namespace menu_framework {
	...
	void slider(std::int32_t x, std::int32_t y, std::int32_t offset, std::int32_t lenght, unsigned long font, const std::string string, float& value, float min_value, float max_value);
